...
type
  ...
  public
    ...
    procedure PreSelectPort(portNum: Integer);
  end ;
...
procedure TComPortSelector.FormCreate(Sender : TObject) ;
var
  I                 : Integer ;
  S                 : string ;
begin
...
procedure TComPortSelector.PreSelectPort(portNum : Integer) ;
var
  sPortNum          : string ;
  ndx               : Integer ;
begin
  sPortNum := 'COM' + IntToStr(portNum) ;
  ndx := PortsComboBox.Items.IndexOf(sPortNum) ;
  if ndx > -1 then
    PortsComboBox.ItemIndex := ndx ;
end ;

function TComPortSelector.SelectedCom : string ;
begin
  Result := PortsComboBox.Items[PortsComboBox.ItemIndex] ;
end ;

function TComPortSelector.SelectedComNum : Word ;
var
  S                 : string ;
begin
