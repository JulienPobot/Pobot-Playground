 ...
 *
 * Modified by J. Holtzer (Pobot) for Arduino BT
 *
 * Command format is:
 * pos description
 *  0   <startbyte>
...
int RESET = 7;  // add reset pin for Bluetooth Arduino
...
void setup()
{
  ...
  Serial.begin(115200);  // BT uses 115200 by default
...
void loop()
{
  ...
  Serial.print(sendlen,HEX);
  Serial.print(" recvlen:"); 
  Serial.print(recvlen,HEX);
  Serial.print(" cmd[0..7]:"); 
